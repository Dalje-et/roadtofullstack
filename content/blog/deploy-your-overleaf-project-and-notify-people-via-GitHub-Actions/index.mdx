...
The only step left is to commit your workflow into your repository. Afterwards, check the <i>Actions</i> tab in your repository. Your workflow should be visible now. I created a <a href="https://github.com/Dalje-et/LaTeX-Compilation-Demo" target="_blank" rel="noreferrer">demo repository</a> where you can find the complete .yaml file.
Here is a video showing how it would look like when using Overleaf:
